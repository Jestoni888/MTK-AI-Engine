...
•Added GPU governor selection on per-app also fixed GPU frequency on per-app functions & fallback to global setup in advance GPU frequency setup in Webui if no config found in per-app
