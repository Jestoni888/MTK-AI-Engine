...
async function initDynamicSysctl(forceRefresh = false) {
    ...
    container.innerHTML = '<div style="padding:20px; text-align:center;">🔍 Deep Scanning /proc/sys/<br><span style="font-size:10px; color:#666">This may take 5-10 seconds</span></div>';
