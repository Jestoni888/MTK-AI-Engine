...
async function startGlobalSearch() {
    ...
    setTimeout(async () => {
        try {            // ⚠️ SAFE PATHS ONLY
            const safeBasePaths = "/sys/class /sys/devices /sys/ /dev/ /vendor/ /sys/module /proc/sys /proc/thread-self /proc/swpm /proc/ppm /proc/pmsr /proc/net /proc/mtktz /proc/mtk_lpm /proc/gpufreqv2 /proc/fs /proc/driver /proc/device-tree /proc/cpufreq /proc/asound /data";
