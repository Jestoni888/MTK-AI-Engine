// update.js - Background-Powered Update Notifier (Simplified)
(function() {
    'use strict';
    ...
    async function loadChangelog() {
        ...
        // Method 1: fetch() inside the WebView (uses the manager app's internet permission)
        ...
        // Method 2: shell fallbacks (busybox wget → curl → wget)
        if (!md || !md.trim()) {
            try {
    ...
    function showUpdateModal(data) {
        ...
        // 🚀 Fetch and render the online changelog
        loadChangelog();
        ...
        document.getElementById('dl-btn').onclick = async () => {
            ...
            const poll = setInterval(async () => {
                ...
                if (isDone) {
                    ...
                    // Remove update status file after successful download
